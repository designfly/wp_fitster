		...
		<?php if ( ! empty( $available_methods ) ) : ?>
			...
			<?php else : ?>
					...
					<?php foreach ( $available_methods as $method ) : ?>
							...
							<label for="shipping_method_<?php echo $index; ?>_<?php echo sanitize_title( $method->id ); ?>"><?php echo wp_kses_post( wc_cart_totals_shipping_method_label( $method ) ); ?></label></br>
					<?php endforeach; ?>
